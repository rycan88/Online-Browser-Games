    ...
    return (
        ...
        {  
            discardPile.map((card, index) => {
                return (
                    <div className={`absolute ${(index === discardPile.length - 1) ? "border-[0.5px] border-black" : "border-l-[0.5px] border-b-[0.5px]"} ${(index === discardPile.length - 1 && canPick) && "hover:translate-x-[4px] hover:-translate-y-[4px]"}`}
                        style={{
