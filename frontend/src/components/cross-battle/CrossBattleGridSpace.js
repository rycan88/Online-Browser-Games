...
export const CrossBattleGridSpace = ({tileSize, isMiddle, offset, id, tileData}) => {
    ...
    return (
        <div className={`absolute flex items-center justify-center bg-gradient-to-br bg-slate-700 border-none text-black rounded-[10%] touch-none`} 
